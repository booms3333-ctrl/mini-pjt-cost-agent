...
(`AGENT_TOOLS["optimization_agent"]`, [agent.py:107-110](../src/agent.py#L107-L110))
...
배분, 예산, 조건
```
(`_OPTIMIZATION_KEYWORDS`, [agent.py:119-122](../src/agent.py#L119-L122))

**"계획"류 복합 질의**는 [anomaly_agent.md](anomaly_agent.md)와 함께 자동 라우팅된다
(Plan-Execute 2단계 분해, [agent.py:167-168](../src/agent.py#L167-L168)).

## 핵심 행동 규칙

시스템 프롬프트([agent.py:228-241](../src/agent.py#L228-L241))에 강제된 **절대 규칙**:
